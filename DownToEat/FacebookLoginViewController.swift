...
class FacebookLoginViewController: UIViewController, FBSDKLoginButtonDelegate
{
    ...
    @IBAction func loginDidTouch(sender: AnyObject) {
        firebase.authAnonymouslyWithCompletionBlock { (error, authData) in //log user in
            if error != nil { print(error.description); return } //check for authentication error
            self.performSegueWithIdentifier("LoginToChat", sender: nil) //trigger segue to move to MessengerController
        }
    }
    ...
    {
        super.viewDidLoad()
        firebase = Firebase(url: "https://grab-a-bite.firebaseio.com/")
