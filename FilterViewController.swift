...
class FilterViewController: UIViewController {
    ...
    override func viewDidLoad() {
		...
		let leftButton =  UIBarButtonItem(title: "Cancel", style:   UIBarButtonItemStyle.Plain, target: self, action: #selector(FilterViewController.btn_clicked(_:)))
        //need to go back to search
        //let rightButton =  UIBarButtonItem(title: "Search", style:   UIBarButtonItemStyle.Plain, target: self, action: #selector(BusinessesViewController.btn_clicked(_:)))
		
		self.navigationItem.leftBarButtonItem = leftButton
        //self.navigationItem.rightBarButtonItem = rightButton //go back to restaurant
...
extension FilterViewController: UITableViewDataSource, UITableViewDelegate, FilterCellDelegate {
    //make section headers orange
//    func tableView(tableView: UITableView, viewForHeaderInSection section: Int) -> UIView? {
//        let headerColor : UILabel = UILabel()
//        headerColor.backgroundColor = UIColor.orangeColor()
//        return headerColor
//    }
    ...
    func tableView(tableView: UITableView, cellForRowAtIndexPath indexPath: NSIndexPath) -> UITableViewCell{
        ...
        case 1:
            ...
            let tapGesture = UITapGestureRecognizer(target: self, action: #selector(FilterViewController.onDistanceCellTapped(_:)))
        ...
        case 2:
            ...
            let tapGesture = UITapGestureRecognizer(target: self, action: #selector(FilterViewController.onSortCellTapped(_:)))
            cell.addGestureRecognizer(tapGesture)
            return cell
        ...
        case 3:
            ...
            let tapGesture = UITapGestureRecognizer(target: self, action: #selector(FilterViewController.onCategoryCellTapped(_:)))
            cell.addGestureRecognizer(tapGesture)
            return cell
...
//        let storyboard: UIStoryboard = UIStoryboard(name:"Main", bundle: NSBundle.mainBundle())
//        let detailViewController: UIViewController = storyboard.instantiateViewControllerWithIdentifier("DetailViewController") as! DetailViewController
//        
